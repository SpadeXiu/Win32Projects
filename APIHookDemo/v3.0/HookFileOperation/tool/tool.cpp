	...
	)
{
	...
	if (hLogFile != INVALID_HANDLE_VALUE)
	{
		...
		sprintf(szMessage, "\r\n#%s# Process [%ws]--[%d] is calling \"CreateFileW\", FileName: %ws, DesiredAccess: 0x%.8x\r\n",
	...
	)
{
	...
	if (hLogFile != INVALID_HANDLE_VALUE)
	{
		...
		sprintf(szMessage, "\r\n#%s# Process [%ws]--[%d] is calling \"CreateFileA\", FileName: %s, DesiredAccess: 0x%.8x\r\n",
			szTime, szProcessPath, dwProcessId, lpFileName, dwDesiredAccess);
	...
	)
{
	...
	if (hLogFile != INVALID_HANDLE_VALUE)
	{
		...
		sprintf(szMessage, "\r\n#%s# Process [%ws]--[%d] is calling \"ReadFile\", FileName: %ws\r\n",
	...
	)
{
	...
	if (hLogFile != INVALID_HANDLE_VALUE)
	{
		...
		sprintf(szMessage, "\r\n#%s# Process [%ws]--[%d] is calling \"ShellExecuteA\", Operation: %s, File: %s\r\n",
	...
	)
{
	...
	if (hLogFile != INVALID_HANDLE_VALUE)
	{
		...
		sprintf(szMessage, "\r\n#%s# Process [%ws]--[%d] is calling \"ShellExecuteW\", Operation: %ws, File: %ws\r\n",
			szTime, szProcessPath, dwProcessId, lpOperation, lpFile);
